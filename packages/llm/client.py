            ...
            return json.dumps(
                {
                    ...
                    "github_evidence": [
                        {
                            "repo": "mchittineni/tf-arch-diagram-generator",
                            "commit": "main",
                            "feature": "JSON to Mermaid AST",
                        }
                    ],
                    "counterarguments": [
                    ...
                    "code_checks": [
                        {
                            "tool": "terraform",
                            "passed": True,
                            "details": "Terraform HCL syntax verified and validated",
                        },
                        {
                            "tool": "ruff",
                            "passed": True,
                            "details": "Python parser scripts passed lint checks",
                        },
                    ],
                }
            )
            ...
            return json.dumps(
                {
                    ...
                    "faq": [
                        {
                            "q": "Can terraform graph replace architecture diagrams?",
                            "a": "Native terraform graph outputs raw DOT files which quickly become incomprehensible at scale without intelligent filtering and AST clustering.",
                        }
                    ],
                    "related_topics": [
